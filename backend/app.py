...
def seed_data():
    ...
    products_data = [
        ...
        {"name": "Belkin MagSafe 3-in-1 Charger", "categories": ["Mobile Accessories"], "price": 12999, "sales_price": 10999, "stock": 13, "sku": "BLK-M3W", "description": "Wireless charging stand for iPhone, Apple Watch and AirPods", "images": ["https://images.unsplash.com/photo-1633576429634-1c7c0c2c1c1c?auto=format&fit=crop&w=1200&q=85"]},
    ]
